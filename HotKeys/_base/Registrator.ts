...
/**
 * Контрол DefaultActionRegistrator - хок, который указывает клавиши, нажатие на которые будет обработано по умолчанию дочерним контролом.
 * Он регистрирует клавиши по умолчанию для всех предков, у которых еще нет зарегистрированного действия на эту клавишу, и,
 * в случае необработанного нажатия этих клавиш, в дочерний контрол хока будет перенаправлено событие о нажатии на клавишу, и там будет обработано.
 */
