...
abstract class WasabyEvents implements IWasabyEventSystem {
    ...
    private clickStateTarget: { target: HTMLElement, touchId: number }[] = [];
    ...
    protected _handleClick(event: MouseEvent): void {
        this.shouldUseClickByTapOnClick(event);
    ...
    protected _handleTouchmove(event: ITouchEvent): void {
        this.shouldUseClickByTapOnTouchmove(event);
    ...
    protected _handleTouchend(event: ITouchEvent): void {
        this.shouldUseClickByTapOnTouchend(event);
    ...
    protected shouldUseClickByTapOnClick(event: MouseEvent): void {
    ...
    protected shouldUseClickByTapOnTouchstart(event: ITouchEvent): void {
        if (this.shouldUseClickByTap()) {
    ...
    protected shouldUseClickByTapOnTouchmove(event: ITouchEvent): void {
        if (this.shouldUseClickByTap()) {
    ...
    protected shouldUseClickByTapOnTouchend(event: ITouchEvent): void {
    ...
    protected setPreventShouldUseClickByTap(value: boolean): void {
