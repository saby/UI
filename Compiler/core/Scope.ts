 ...
 * @author Крылов М.А.
 * @file Compiler/core/Scope.ts
 */

import * as Ast from './Ast';
import { ITranslationsRegistrar } from './Text';
import { IPath } from './Resolvers';
import { Dictionary, ITranslationKey } from '../i18n/Dictionary';
...
import createController, { IDependenciesController } from '../core/Dependencies';
