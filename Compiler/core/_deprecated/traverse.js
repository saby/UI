 ...
 */
define('Compiler/core/_deprecated/traverse', [
   'Core/Deferred',
    ...
    * @author Крылов М.А.
    * @file Compiler/core/_deprecated/traverse.js
    */
   ...
   function checkForAttributes(entity) {
      if (entity.attribs && Object.keys(entity.attribs || {}).length === 0) {
