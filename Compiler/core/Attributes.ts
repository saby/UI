 ...
 * @author Крылов М.А.
 * @file Compiler/core/Attributes.ts
 */
...
import { ITextProcessor, TextContentFlags, ITranslationsRegistrar } from 'Compiler/core/Text';
import { INodeDescription } from 'Compiler/i18n/Translator';
import { IValidator } from 'Compiler/expressions/_private/Validator';
