...
/**
 * @description Модуль предоставляет интерфейс и класс конфигурации компиляции шаблона.
 * @author Крылов М.А.
 */
...
export class Options implements IOptions {
   ...
   /**
    * Initialize new instance of option class.
    * @param options {IOptions} Options configuration.
    */
