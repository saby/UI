...
/**
 * @description Модуль предоставляет интерфейс и классы для логгера, форматтера и обработчика ошибок
 *  с возможностью вывода различных диагностических сообщений.
 * @author Крылов М.А.
 */
...
export interface ILogger {
    ...
    * @returns {string | null} Returns message text or null.
    */
