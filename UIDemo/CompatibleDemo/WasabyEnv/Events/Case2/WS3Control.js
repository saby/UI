define('UIDemo/CompatibleDemo/WasabyEnv/Events/Case2/WS3Control', [
   'Lib/Control/CompoundControl/CompoundControl',
   'tmpl!UIDemo/CompatibleDemo/WasabyEnv/Events/Case2/WS3Control'
   ...
   var WS3Control = CompoundControl.extend({
      ...
      init: function(opts) {
         ...
         require(['UIDemo/CompatibleDemo/WasabyEnv/Events/Case2/WasabyControl'], function(WasabyControl) {
