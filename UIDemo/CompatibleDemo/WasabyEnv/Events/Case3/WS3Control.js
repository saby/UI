define('UIDemo/CompatibleDemo/WasabyEnv/Events/Case3/WS3Control', [
   'Lib/Control/CompoundControl/CompoundControl',
   'tmpl!UIDemo/CompatibleDemo/WasabyEnv/Events/Case3/WS3Control'
   ...
   var WS3Control = CompoundControl.extend({
      ...
      init: function(opts) {
         ...
         require(['UIDemo/CompatibleDemo/WasabyEnv/Events/Case3/WasabyControl'], function(WasabyControl) {
